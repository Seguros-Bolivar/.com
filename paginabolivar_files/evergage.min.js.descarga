...
// fe67a12b28a9413e467194f6 pruebas damian 
let debug = true;
const getCookieDomain = () => {
    let domain = window.location.hostname;
    //if (debug) console.log("MCP DOMINIO =>", domain); 
    if(domain === "pre.segurosbolivar.com" || domain === "stg-web.segurosbolivar.com" || domain === "clientes.segurosbolivar.com" || domain === "transac.segurosbolivar.com" || domain === "novedades.segurosbolivar.com"|| domain === "segurosbolivar.com" || domain === "www.segurosbolivar.com" || domain === "digital.segurosbolivar.com" || domain === "stg-digital.segurosbolivar.com") {   
        //console.log("MCP cookie domain", domain);
        return "segurosbolivar.com"; 
    }
};
...
Evergage.init({
  ...
  cookieDomain: cookieDomain, // Optional tracking cookie domain configuration (overrides default)
    ...
    console.log("MCP Seguros Bolivar 120, cd: ",cookieDomain);
      ///////////////
     /////BTN´S/////
    ///////////////
    const sitemapConfig = {
      ...
      name: "default",
        ...
        pageTypes: [
            ...
            },
            {
                ...
                contentZones: [
                    {
                        name: "mvp_poppup_formulario_vida_v2",
    ...
    //ITEMS de las categorias y secciones
